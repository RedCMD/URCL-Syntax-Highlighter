...
async function activate(context) {
	...
	const wasm = context.asAbsolutePath('out/tree-sitter/tree-sitter-URCL.wasm')
	for (const selector of DocumentSelector)
		registerLanguage(selector.language, wasm)
	...
	subscribeToDocumentChanges(context, DiagnosticCollection, vscode.languages.createDiagnosticCollection("urcl")) // squiggle errors
}
